...
describe('useKeyboardShortcutsV2', () => {
  const mockHandlers = {
    onNewTask: vi.fn(),
  ...
  describe('Basic functionality', () => {
    it('should register keydown event listener on mount', () => {
      ...
      renderHook(() => useKeyboardShortcutsV2(mockHandlers));
    ...
    it('should remove event listener on unmount', () => {
      ...
      const { unmount } = renderHook(() => useKeyboardShortcutsV2(mockHandlers));
    ...
    it('should return shortcuts list', () => {
      const { result } = renderHook(() => useKeyboardShortcutsV2(mockHandlers));
  ...
  describe('Modal handling', () => {
    it('should ignore shortcuts when modal is open except Escape', () => {
      renderHook(() => useKeyboardShortcutsV2(mockHandlers, { isModalOpen: true }));
